      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          <div className="mt-8 md:mt-0">
            <a href="/horario.pdf" target="_blank" rel="noopener noreferrer" className="text-lime-400 font-bold hover:text-lime-300 flex items-center gap-2 group border border-lime-400/20 px-6 py-3 rounded-full hover:bg-lime-400/10 transition-all">
        ...
        <div className="flex overflow-x-auto pb-6 mb-8 gap-3 scrollbar-hide snap-x">
          {days.map((day) => (
            <button
              ...
              className={`snap-start px-8 py-4 rounded-xl font-bold whitespace-nowrap transition-all duration-300 border-2 ${activeDay === day
          ...
          {SCHEDULE_DATA[activeDay].map((slot, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <div className={`p-2 rounded-full ${slot.difficulty === 'Alto' ? 'bg-red-500/10 text-red-400' :
